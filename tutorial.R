...
tree_without_cofactors <- lapply(tree_without_cofactors, function(x){
...
tree_without_cofactors <- tree_without_cofactors[!is.na(tree_without_cofactors)]
...
plots <- plotMetaboliteContribution(enzyme = 'MMUT', 
